...
if __name__ == '__main__':
    csv_dir = r"../../../datasets/良性二分类.csv"  # 按该路径下csv文件加二分类标签
    data_path = r"D:\Dataset\key_frame_10_all_mat_5_c\data"  # 源数据路径，有临床信息
    t_data_path = r"D:\Dataset\key_frame_10_all_mat_5_c_2_lx_zj\data"  # 目标数据保存路径
    ...
    for i in range(len(csv_data) - 1):
        ...
        labels_2 = [0, 1]
        if csv_data[j][7] == '0':  # 结核
            labels_2 = [0, 1]
        elif csv_data[j][7] == '1':  # 增生
            labels_2 = [1, 0]
        else:
