...
import sys
from codes.datas.classification_2_b.r_dataset_load_mat_2 import *
from codes.models.classification_2_b.vm_classification_2_b_model import *
...
class OptimizerParamClass:
    def __init__(self):
        ...
        self.prior_knowledge = torch.tensor([1, 0.6, 0.3, 0.05, 0.05])
        self.seed = 1234

        self.datasets_path = r"D:\Dataset\key_frame_10_all_mat_5_c_2_lx_zj_a"
        self.models_save_path = "../../../checkpoints/classification_2_b/" + self.model_name  # 模型保存路径
        self.results_save_path = "../../../results/classification_2_b/" + self.model_name  # 模型保存路径
        self.wandb_project = ""
